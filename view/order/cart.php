...
$total = 0;
?>
<a href="http://localhost/tokobuku/index.php?page=order" class="btn btn-primary">Kembali</a>
...
<div class="pull-right"><a href="controller/ordercontroller.php?page=selesai&total=<?=$total?>" class="btn btn-success">Selesai</a></div>
